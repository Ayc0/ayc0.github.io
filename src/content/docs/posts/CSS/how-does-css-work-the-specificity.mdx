...
![Parsel parsing "#foo > .bar + div.k1.k2 [id='baz']:nth-child(2n of .k3):not(:where(#yolo))::before" and determining its specificity (1,6,2)](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/umseei3lx99qfkg9ip65.png)

#### VSCode

Similarly, VSCode can parse selectors and display their specificity on hover.

![VSCode parsing "#foo > .bar + div.k1.k2 [id='baz']:nth-child(2n):not(:where(#yolo))::before"](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/0inob8t4o2jow1j5rwc2.png)
