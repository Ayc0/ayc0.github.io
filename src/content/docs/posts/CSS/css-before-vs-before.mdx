...
sidebar:
  order: 2
image: /src/assets/8ivvscot8k45jb540grv.png
...
![Visual representation of `span::hover`](@assets/8pbfu10w6omks0zpp7pn.png)
...
![Visual representation of `span::first-letter`](@assets/msnfwiraud02blaskatr.png)
