...
series:
  name: "Light/dark"
  order: 1 # Another post was created the 2021-05-30, so this is to say that it needs to be set after
description: "In this article, we’ll see how we can implement the logic to switch back & forth between light/dark mode"
atUri: "at://did:plc:wifmfjqoxnruni5h62e6zp2y/site.standard.document/3mn6dw4wnzy2z"
---
...
<LinkToPost slug="light-dark-mode-the-simple-way" />
