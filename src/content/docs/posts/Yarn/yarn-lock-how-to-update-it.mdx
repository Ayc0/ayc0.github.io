...
![Illustration showing that A imports B@^1.1.1 resolved in B@1.1.4, and that C imports B@^1.1.5 resolved in B@1.1.5, resulting in having 2 versions of B](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/4x6b8eid6ue1tyjzsy43.png)

But ideally, you should end up like that:

![Illustration showing that A imports B@^1.1.1 resolved, and C imports B@^1.1.5, both resolved in B@1.1.5, resulting in having only 1 version of B](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/m4pt38rne6ghcz9rx3yj.png)
...
![output of yarn 1' "yarn list" command](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/mcsxmz3rhti0lro89ur0.png)
...
![Output of the command "yarn why {'<'}package{'>'}", showing all the versions of this package installed, why it was installed, what version range was required each time, and which versions were resolved](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/ep7g6avdbbj7qgalznb6.png)
...
![Output of the command "yarn why {'<'}package{'>'} -R", showing the same results as before, but also including all of the parent deps of those deps, recursively](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/g7z3svnxfq8oz43ogycn.png)
