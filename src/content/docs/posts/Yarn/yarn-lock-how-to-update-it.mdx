...
![Illustration showing that A imports B@^1.1.1 resolved in B@1.1.4, and that C imports B@^1.1.5 resolved in B@1.1.5, resulting in having 2 versions of B](@assets/4x6b8eid6ue1tyjzsy43.png)

But ideally, you should end up like that:

![Illustration showing that A imports B@^1.1.1 resolved, and C imports B@^1.1.5, both resolved in B@1.1.5, resulting in having only 1 version of B](@assets/m4pt38rne6ghcz9rx3yj.png)
