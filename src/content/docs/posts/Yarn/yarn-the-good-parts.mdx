...
By default, yarn berry uses PNP and not node_modules. But `nodeLinker: node-modules` will tell it to use node_modules/ again. This linker is fully stable, and makes Yarn fully compatible with the rest of the ecosystem. I’ve never seen any single project that weren’t working with it (even React-Native projects).
