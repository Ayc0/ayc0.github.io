...
`@blocz/react-responsive` v4 was just released with a few removal of deprecated APIs. Those are `<Match>` and the CSS-in-JS support. You can check out the full release details here: https://github.com/bloczjs/react-responsive/releases/tag/v4.0.0
