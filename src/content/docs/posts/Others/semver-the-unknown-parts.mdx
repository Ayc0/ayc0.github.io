...
![Screenshot of semver spec saying "And one with numbered capture groups instead (so cg1 = major, cg2 = minor, cg3 = patch, cg4 = prerelease and cg5 = buildmetadata)"](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/dyn2hb56xwjex3cyd6hr.png)
...
![semver properly parses `1.2.3-pre.release.4.5+build.meta.6.7`](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/niejqzhlppdlxyaj1tez.png)
...
![Sample of React versions on NPM with a lot of prereleases](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/p00o9cthqgf0s4dlhymu.png)
