...
![Content of the project after the npx command for CRA](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/f7hssdymps5lg2b164zj.png)
...
![Content of the project after npm i for Parcel](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/1krgnawdnkc7h24s90ez.png)
...
![diff between CRA's index.html and Parcel's index.html](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/3ky8dvgyrc6shb9trauz.png)
