...
![Grapheme vs code unit vs code point](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/fty25unybapraxyaslkr.png)
...
![$, €, and 𐐷 encoded in UTF-16 in code units](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/sd3zmt59k7stx73bffh2.png)
...
![Ç {'<->'} C+◌̧](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/5dhf9yjoybqftvm6l3a7.png)
...
!["Å" can be decomposed into "A+̊ " or precomposed as "Å"](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/uxrpqqryzmd2ol5od655.png)
...
![Browser compatibility table](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/be4uvsnzw835ppsh6tqq.png)
