...
If you want to see a concrete application of these rules, you can check [this post](/projects/posts/others/migrating-class-components-to-hooks/) in which I wrote a detailed migration of [react-only](https://www.npmjs.com/package/react-only)
